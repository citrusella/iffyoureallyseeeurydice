...
- The window can scroll if the content grows too tall for the window, but it is currently not showing a scroll bar to indicate this, even though scrolling still works if you have a non-scrollbar way to scroll available to you. ...I have *no idea* why the very simple task of adding the built-in scrollbar widget breaks every part of the program when I try.
